...
public class RangeCombatState : BaseEnemyState
{
    ...
    public override void Enter()
    {
        ...
        range.StartStateCoroutine(CombatRoutine());
    }
    ...
    protected virtual IEnumerator CombatRoutine()
    {
        ...
        if (range.FirstAttack)
        {
            ...
            range.LastAttackTime = Time.time;
        ...
        while (actionTimer < 2.0f)
        {
            ...
            if (Time.time >= range.LastAttackTime + range.EnemyWeaponController.FireRate)
            {
